...
public class ForecastGatherer {
    ...
    public City getCityForecast(City city) {
        ...
        String URL="";
        URL = "http://api.wunderground.com/api/b2d97c37f90887e5/forecast10day/q/";
        URL += city.getCountry() + "/" + city.getCityName() + ".json";
        System.out.println("im the erro" + URL);
        try {
...
//    public City getCityForecastForLeuven(City city) {
//        Client client = ClientBuilder.newClient();
//        ObjectMapper objectMapper = new ObjectMapper();
